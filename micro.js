...
/* ===============================
   MOBILE KEYBOARD EDIT FIX (Layout toolbars)
   Keeps inputs editable without iOS zoom + provides breathing room
   =============================== */
@media (max-width: 768px) {
  #bedOffsetControls input,
  #bedOffsetControls select,
  #bedOffsetControls textarea,
  #obstacleControls input,
  #obstacleControls select,
  #obstacleControls textarea,
  .obstacle-row input,
  .obstacle-row select,
  .obstacle-row textarea {
    font-size: 16px;
  }
}
